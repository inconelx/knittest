<template>
  <div class="login-container">
    <el-card class="login-card">
      ...
      <br />
      <el-form :model="form" @submit.prevent="handleLogin" class="login-items">
        <el-form-item label="用户名" style="width: 100%;">
          <el-input v-model="form.user_name" maxlength="30" />
        </el-form-item>
        <el-form-item label="&#12288密码" style="width: 100%;">
          <el-input v-model="form.user_password" show-password maxlength="20" />
        </el-form-item>
        <el-form-item label="&#12288&#12288&#12288" style="width: 100%;">
